...
この演習では、無料ツールのAzure Designerを使用し、Fabricのアーキテクチャを説明する図を作ります。

Azure Designerは、Microsoft の公式なツールではありません。Microsoft の社員がアーキテクチャを説明するために作った便利なリソースです。
...
## Azure Designerへのアクセスと準備

先ずは以下のリンクをコピーして、ブラウザでアクセスしてください。

```
<Azure Designer Link Goes Here>
```
